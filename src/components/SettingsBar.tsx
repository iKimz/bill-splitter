...
import { Percent, Tag, ReceiptText, HeartHandshake } from 'lucide-react';
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs p-4 sm:p-5 mb-6 transition-colors duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Subsidize / Discount */}
        <div className="bg-emerald-50/60 dark:bg-emerald-950/40 rounded-xl p-3 border border-emerald-100 dark:border-emerald-900/60">
          <div className="flex justify-between items-center mb-1.5">
            <label className="text-xs font-semibold text-emerald-800 dark:text-emerald-300 flex items-center gap-1">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="w-full bg-white dark:bg-slate-800 border border-emerald-300 dark:border-emerald-700 rounded-lg px-3 py-2 text-sm font-bold text-emerald-700 dark:text-emerald-400 focus:ring-2 focus:ring-emerald-500 outline-none transition-all pr-12"
              placeholder="0"
            />
